---
title: Communication and Team Organization
---
...
We will be using a group chat based through our phone numbers. 
We additionally will be using a discord server.
The instructor will be contacted by an individual while attaching all team members in the email.
...
> We will be using a shared group chat and will hold each other accountable for coming to meetings. Additionally this allows us to schedule any additional meeting time. For longer term coordination we have a discord server.

How will your team go about changing or adding meeting times?
> If there's any complication the groupchat will be used. Worst case a phone call can be placed through discord or phone number.

What's the preferred format for meetings (face-to-face or virtually)?
>We will be having face to face meetings in the ASU polytech dining hall and student union.
 
Are there any other procedures that your team feels are necessary? Describe them.
> We will have a late work system. If a due date is within 3 days and the relevant assignment is not prepared you have to tell the group.
